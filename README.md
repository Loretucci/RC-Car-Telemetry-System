...
Designed and implemented a serial telemetry interface for a 1:8 scale autonomous rover, establishing communication between Teensy 4.1 and Arduino boards via UART protocol using Model-Based Design in Simulink
